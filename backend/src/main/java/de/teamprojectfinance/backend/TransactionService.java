...
public class TransactionService {
    ...
    public Transaction addTransaction(TransactionWithNoId transactionWithNoId) {
        return transactionRepo.insert(new Transaction(idService.createRandomId(), transactionWithNoId.getDescription(), transactionWithNoId.getAmount(), transactionWithNoId.getCategory(), transactionWithNoId.getDate()));
    }
    ...
    public Transaction updateTransaction(TransactionWithNoId transactionWithNoId, String id){
        ...
        return transactionRepo.save(new Transaction(id, transactionWithNoId.getDescription(),
                transactionWithNoId.getAmount(), transactionWithNoId.getCategory(), transactionWithNoId.getDate()));
    }
